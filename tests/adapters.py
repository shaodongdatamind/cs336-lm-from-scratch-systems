...
from cs336_systems.flashattention_pytorch import FlashAttention2AutogradFunction
...
def get_flashattention_autograd_function_pytorch() -> Type:
    ...
    """
    return FlashAttention2AutogradFunction
...
def get_flashattention_autograd_function_triton() -> Type:
    ...
    Returns:
        A class object (not an instance of the class)
    """
    return FlashAttention2TritonAutogradFunction
